...
export default function ManageEvaluatorsPage() {
  ...
  const toggleActive = async (r: Evaluator) => {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-medium text-[#004f9f]">Manage Evaluators</h1>
        <button onClick={() => { setShowForm(true); setFormError(''); }}
          ...
          <Plus size={15} /> Add Evaluator
        </button>
      </div>

      <div className="grid grid-cols-2 gap-3">
        {[
          { label: 'Total Evaluators', value: stats.total, color: 'bg-blue-50 text-[#004f9f]' },
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-4 overflow-hidden">
            <div className="bg-[#004f9f] px-5 py-4 flex items-center justify-between">
              <div>
                <p className="text-[10px] font-bold uppercase tracking-widest text-white/50">New Evaluator</p>
                <p className="text-white font-bold text-sm mt-0.5">Create Evaluator Account</p>
              </div>
            ...
            <div className="p-5 space-y-4">
              <div>
                ...
                <input type="text" placeholder="Evaluator full name" value={name} onChange={e => setName(e.target.value)}
              ...
              <div>
                ...
                <input type="email" placeholder="evaluator@example.com" value={email} onChange={e => setEmail(e.target.value)}
                  autoComplete="off"
                  className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#004f9f]" />
              </div>
              <div>
